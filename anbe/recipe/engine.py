...
class RecipeEngine:
    ...
    def generate(self, ctx):
        ...
        project = Path(ctx.path)

        recipe = {
            "schema": "anbe.recipe.dynamic.v2",
            "project": str(project),
            "steps": [],
            "android_root": None,
            "artifact": None
        ...
        if android_root is not None:
            ...
            try:
                relative_android = android_root.relative_to(
                    project
                )
            ...
            recipe["android_root"] = android_root_value
            ...
            if android_root == project:
                ...
                artifact_path = (
                    str(
                        android_root.relative_to(project)
                    )
                    +
                    "/app/build/outputs/apk/debug/"
                    "app-debug.apk"
